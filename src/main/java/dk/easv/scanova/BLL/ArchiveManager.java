...
public class ArchiveManager {
    ...
    public void createArchive(String name, int clientId, int userId) throws Exception {
        validateName(name);
        if (clientId <= 0)
    ...
    public void updateArchive(int id, String name, int userId) throws Exception {
        validateName(name);
    ...
    public void reactivateArchive(int id, int userId, String name) throws Exception {
