...
public class ImagePreviewController {
    ...
    @FXML private TextField rotationField; // exact degree input from version 2
    ...
    private void initialize() {
        ...
        // Slider → update rotation and field
        ...
        // Field → update rotation and slider
        if (rotationField != null) {
    ...
    public void setImage(Image image, ScannedFile file, double brightness) {
        ...
        // Set slider and field to file's current rotation
